<script lang="ts">
	...
	let canvasContainerRef = $state<HTMLDivElement | null>();
	let context: CanvasRenderingContext2D | null = null;
	let circles: ReturnType<typeof circleParams>[] = [];
	let mouse = { x: 0, y: 0 };
	...
	function drawCircle(circle: ReturnType<typeof circleParams>, update = false) {
		if (context) {
