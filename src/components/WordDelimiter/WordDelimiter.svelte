...
<div class="w-full flex flex-col justify-center items-center z-1 select-none">
	<div class="w-full flex gap-5 justify-center items-center overflow-hidden uppercase">
