...
<div class="grid grid-cols-8 auto-rows-min grid-flow-col gap-x-4 mt-15 mb-50">
	<div class="col-start-3 col-span-3 flex flex-col gap-6 mb-9">
		...
		<span class="text-xl">
			Лаборатория светотворчества в школе Сколка: серия коллективных световых работ, выставка
			в кампусе школы, участие в фестивале научного искусства «Частоты 6.0» и коллаборация с НИЯУ МИФИ в павильоне «АТОМ».
		</span>
	</div>
