...
export const TEAM_MEMBERS_LIST: {
...
}[] = [
	{
		...
		name: 'Вера Линник',
		description:
			'Автор и ведущая проекта. Медиахудожник и фотограф, основатель инициативы «Светотворчество». Выпускница Школы Родченко и Академии фотографии, член МТС «Таврида.АРТ» и секции science art Творческого Союза Художников России.',
		tag: 'Искусство',
